...
def reformat_legacy_gsp_data(gsp_zarr_path: str, gsp_metadata_csv_path: str,
                            save_path: str) -> None:
    ...
    gsp_meta["longitude"], gsp_meta["latitude"] = osgb_to_lon_lat(
        gsp_meta["x_osgb"].values, gsp_meta["y_osgb"].values,
        )
...
def reformat_legacy_site_data(site_netcdf_path: str, site_metadata_csv_path: str,
    ...
    if hasattr(ds_site,"capacity_mwp"):
        ...
        ds_with_meta = ds_with_meta.assign_coords(
            ...
            longitude=(
                "location_id",
                site_meta.set_index("location_id").loc[ds_with_meta.location_id.values,"longitude"],
                ),
        )

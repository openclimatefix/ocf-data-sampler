...
def rename_to_legacy_variables(ds: xr.Dataset) -> xr.Dataset:
    """Rename channels to old convention names.

    Args:
        ds: xr.Dataset to be updated

    Returns:
        xr.Dataset with renamed channels
    """
    renaming_dict = {

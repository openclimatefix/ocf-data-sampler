...
def create_data(da: xr.DataArray) -> dict:
    return {
...
def add_osgb(example: dict, da: xr.DataArray) -> None:
    osgb_coords = (
        (NWPSampleKey.y_osgb, "y_osgb"),
        (NWPSampleKey.x_osgb, "x_osgb"),
    )
    
    for sample_key, dataset_key in osgb_coords:

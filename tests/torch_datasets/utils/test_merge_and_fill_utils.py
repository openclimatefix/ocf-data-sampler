...
def test_fill_nans_on_numpy_samples(config_filename):
    ...
    # setting custom satellite and nwp values
    # generation can be left as default 0.0
    ...
    # using string keys directly since sample key enums have been removed
    dict = {
    ...
    assert np.array_equal(
        result["satellite_actual"], np.array([1.0, -1.0, 3.0, -1.0]),
    )
